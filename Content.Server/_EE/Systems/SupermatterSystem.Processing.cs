...
public sealed partial class SupermatterSystem
{
    ...
    private void SupermatterZap(EntityUid uid, SupermatterComponent sm)
    {
        ...
        if (zapCount >= 1)
            // Hyperion: dropped upstream `hitCoordsChance: sm.ZapHitCoordinatesChance` arg;
            // Hyperion's LightningSystem.ShootRandomLightnings has no hit-random-coordinates
