...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> AtmosTickRate =
        CVarDef.Create("atmos.tickrate", 15f, CVar.SERVER | CVar.REPLICATED); // Hyperion: SERVERONLY>SERVER|REPLICATED so the supermatter console client can read the real tick rate instead of throwing on an unregistered cvar
